 ...
 /* VIDEO FUNCTIONS */
  ...
  JDMRichmediaYT.prototype.onClickBtn = function(e) {
    ...
    if(JDMRichmediaYT.scope.initialLoad == true) {
      ...
      if(idSelected == 'poster') JDMRichmediaYT.scope.configPlayer.setIdVideo = JDMRichmediaYT.scope.configPlayer.playerObj.arrayIdVideos[0];

      else JDMRichmediaYT.scope.configPlayer.setIdVideo = JDMRichmediaYT.scope.configPlayer.playerObj.arrayIdVideos[posArrayBtn];
